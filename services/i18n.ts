...
export const TRANSLATIONS = {
    en: {
        ...
        music_muted: "MUSIC MUTED",
        skill_stack_caret: "FOCUS: CURSOR",
        skill_stack_corner: "FOCUS: CORNER",
        ...
        init_link: "[2] INITIALIZE LINK",
        quick_session: "A full sector — about 4–6 minutes at your pace.",
        relay_hint: "Prologue · 5 minutes · no loading.",
        relay_replay_hint: "Prologue · play it again with other choices.",
        campaign_hint: "Main campaign · pick a world · 4 sectors.",
        play: "PLAY",
        play_prologue: "Chapter 0 · The Last Relay · 5 minutes, no loading",
        play_session_focus: "focus",
        play_session_pairs: "pairs",
        play_session_pace: "pace",
        focus_name_accuracy: "accuracy",
        focus_name_consistency: "consistency",
        focus_name_speed: "speed",
        focus_name_mastery: "mastery",
        other_world: "Other world",
        practice_title: "PRACTICE · 5 MIN",
        practice_hint: "Check → practice → recheck",
        prologue_again: "Prologue again",
        run_difficulty: "Run difficulty",
        run_difficulty_standard: "standard",
        since_start: "since you started",
        session_goal: "Session focus",
        session_goal_first: "first measurement",
        settings: "Settings",
        relaxed_toggle: "STORY PACE",
        relaxed_hint: "The tracer crawls. Rewards pay 20% less.",
        relaxed_on: "ON",
        relaxed_off: "OFF",
        ...
        black_market: "[4] THE BLACK MARKET",
        operator_record: "[5] OPERATOR RECORD",
        operator_record_hint: "Runs, pace signal, drills.",
    ...
    ru: {
        ...
        sfx_active: "SFX ВКЛ",
        sfx_muted: "SFX ВЫКЛ",
        music_active: "МУЗЫКА ВКЛ",
        music_muted: "МУЗЫКА ВЫКЛ",
        skill_stack_caret: "ФОКУС: КУРСОР",
        skill_stack_corner: "ФОКУС: УГОЛ",
        ...
        init_link: "[2] ИНИЦИАЛИЗАЦИЯ",
        relay_hint: "Пролог · 5 минут · без загрузки.",
        relay_replay_hint: "Пролог · сыграй снова с другими решениями.",
        campaign_hint: "Основная кампания · выбери мир · 4 сектора.",
        play: "ИГРАТЬ",
        play_prologue: "Глава 0 · Последний канал · 5 минут, без загрузки",
        play_session_focus: "фокус",
        play_session_pairs: "пары",
        play_session_pace: "темп",
        focus_name_accuracy: "точность",
        focus_name_consistency: "ровность",
        focus_name_speed: "скорость",
        focus_name_mastery: "мастерство",
        other_world: "Другой мир",
        practice_title: "ТРЕНИРОВКА · 5 МИН",
        practice_hint: "Замер → отработка → повторный замер",
        prologue_again: "Пролог снова",
        run_difficulty: "Сложность забега",
        run_difficulty_standard: "обычная",
        since_start: "с начала",
        session_goal: "Фокус сессии",
        session_goal_first: "первый замер",
        settings: "Настройки",
        relaxed_toggle: "СПОКОЙНЫЙ ТЕМП",
        relaxed_hint: "Трейсер ползёт. Награды −20%.",
        relaxed_on: "ВКЛ",
        relaxed_off: "ВЫКЛ",
        quick_session: "Полный сектор — 4–6 минут в твоём темпе.",
        ...
        black_market: "[4] ЧЕРНЫЙ РЫНОК",
        operator_record: "[5] ДОСЬЕ ОПЕРАТОРА",
        operator_record_hint: "Забеги, темп, тренировки.",
        install_app: "Установить Typomancer как приложение",
        share_score: "СЧЁТ КАРТИНКОЙ",
