...
test('game events pass with flat allowlisted values only',()=>{
 ...
 const safe=send('event',{url:'/?utm_source=x',name:'typomancer_run_started',data:{genre:'noir',run_number:2,returning_player:true,typed_text:'secret',story:'mira',journal:'x',Email:'a@b.c',nested:{a:1}}});
